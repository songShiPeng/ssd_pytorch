...
from ml_data import SIXray_ROOT, SIXrayDetection, SIXray_CLASSES as labelmap
...
imgsetpath = "D:/data/study/mlData/test/core"
...
if __name__ == '__main__':
    ...
    dataset = SIXrayDetection(Config.dataset_test_root
                              , ['core_500', 'coreless_5000']
                              , augmentations.SSDAugmentation(Config.image_size,
                                                              Config.MEANS))
    if args.cuda:
        net = net.cuda()
