...
annopath = os.path.join('D:/data/study/mlData/testscript/Anno_test', '%s.txt')#测试集标注文件路径
test_imagesetfile = 'D:/data/study/mlData/testscript/core_coreless_test.txt'#测试集里面的图片名
'''
